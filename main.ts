...
let counter = 0
let Moosic = false
let TextSprite_Back: TextSprite = null
let Textsprite_Front: TextSprite = null
...
textSprite = textsprite.create("C U B E R O", 0, 4)
